...
**SmartSpend Capstone 2 | Lucid Frame | May 2026**
...
|-------|----------|---------------|-------------------|-----------------|----------|------|-----------|
| **LLaMA 3.1 8B Instant** | Groq | 8,192 | ~800 t/s | ★★★★☆ (Good) | ★★★★☆ | **Free** (30 req/min) | ✅ **YES** |
...
| Gemini 2.0 Flash | Google | 1,000,000 | ~150 t/s | ★★★★☆ (Good) | ★★★★☆ | Free (15 req/min) | 🔄 Backup |
...
| LLaMA 3.1 70B | Meta/Groq | 8,192 | ~300 t/s | ★★★★★ (Excellent) | ★★★★★ | Free (limited) | ❌ Slower |
| Mixtral 8x7B | Mistral/Groq | 32,000 | ~400 t/s | ★★★☆☆ (Fair) | ★★★★☆ | Free (Groq) | ❌ Filipino weak |

---

## Selection Justification: Groq + LLaMA 3.1 8B Instant
