  ...
  static const _steps = [
    _TourStep(
      ...
      body:
          ...
          "The AI logs expenses, updates wallets, sets budgets, tracks debts, and more — 28 action types, all automatic.",
    ),
    _TourStep(
    ...
    _TourStep(
      ...
      body: "• Say 'my GCash is ₱500' to update wallet via AI\n"
          ...
          "• 28 action types + daily quests — check Hub → Achievements",
    ),
  ];
