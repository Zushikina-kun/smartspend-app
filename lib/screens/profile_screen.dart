...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _showSettingsSheet() async {
    ...
    // Add liteMode derived value
    bool liteMode = !showSubscriptions &&
        !showQuickLog &&
        !showBadges &&
        !showMoodHome &&
        !showForecast &&
    ...
    void _applyLiteMode(bool on, StateSetter setSheet) {
      setSheet(() {
    ...
    showModalBottomSheet(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setSheet) {
          // Keep liteMode in sync
          liteMode = !showSubscriptions &&
              !showQuickLog &&
              !showBadges &&
              !showMoodHome &&
              !showForecast &&
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Switch(
                        value: liteMode,
                        onChanged: (v) => _applyLiteMode(v, setSheet),
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        _settingsTile(
                          ...
                          title: "Impulse pause",
                          subtitle:
                              "Confirm before logging large Want expenses",
                        ...
                        _settingsTile(
                          ...
                          title: "Budget alerts",
                          subtitle:
                              "Notify when category budget hits 80% or 100%",
                          value: budgetAlerts,
                          onChanged: (v) {
                        ...
                        _settingsTile(
                          ...
                          subtitle:
                              "Auto-save spare change to your first savings goal (rounds to ₱10)",
                        ...
                        _settingsTile(
                          ...
                          subtitle:
                              "Weekly notification when a category spikes 2.5× above usual",
                          value: anomalyEnabled,
                          onChanged: (v) {
                            setSheet(() => anomalyEnabled = v);
                            DBService.setSetting('anomaly_detection_enabled',
                                v ? 'true' : 'false');
                          },
                        ),
                        const SizedBox(height: 12),
                        ...
                        const SizedBox(height: 4),
                        Text(
                            "Toggle optional cards. Core cards (spending summary, FHS score, budgets) always visible.",
                            style: TextStyle(
                                fontSize: 11, color: Colors.grey[500])),
                        const SizedBox(height: 8),
                        _settingsTile(
                          ...
                          subtitle:
                              "Card showing detected recurring subscriptions",
                        ...
                        _settingsTile(
                          ...
                          subtitle:
                              "One-tap chips for your most frequent expenses",
                          value: showQuickLog,
                          onChanged: (v) {
                            setSheet(() {
                              showQuickLog = v;
                        ...
                        const SizedBox(height: 4),
                        Text(
                            "Pie chart, 50/30/20, and Want/Need are always shown.",
                            style: TextStyle(
                                fontSize: 11, color: Colors.grey[500])),
                        const SizedBox(height: 8),
                        _settingsTile(
