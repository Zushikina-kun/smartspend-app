        ...
        actions: [
          const InfoButton(
            ...
            body:
                ...
                "31 action types: log/update/delete expenses, set budgets, set spending limits, manage goals, debts, recurring, payment plans, insurance/contributions, wallet balances, transfers, salary splits, subscription detection, idle money suggestions, expense cuts, what-if simulation, debt payment plan, split bills, and more.\n\n"
