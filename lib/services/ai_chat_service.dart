...
BSP Open Finance (OFxPERA): live since July 2025, UnionBank first participant. Brankas API available for PH bank integration.""";
  ...
  static Future<(String, List<AIAction>)> sendMessage(String message) async {
    ...
    final systemContent =
        ...
        "IMPORTANT is_want rules: Breakfast/Lunch/Dinner/Brunch/Meal → is_want:false (essential food). Snacks/drinks/energy drinks/junk food → is_want:true. Jeepney/tricycle/bus/commute → is_want:false. Games/steam → is_want:true. Shopping category (gadgets, peripherals, accessories, appliances, clothes, online orders) → is_want:true unless the user explicitly says it is for work or school (e.g. 'work keyboard', 'school uniform'). Juice/soda/energy drinks (Sting, Cobra, Tropicana, Gatorade, Nestea, Pepsi, Coke) → is_want:true.\n"
